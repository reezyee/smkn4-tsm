<template>
  ...
  <div class="bg-[#fefeff] text-black font-titillium">
    ...
    <div class="">
      ...
      <div class="Teachers paddingX">
        <p class="text-[2rem] font-semibold text-center">Guru dan Staff</p>
        <div class="relative w-full overflow-hidden">
          ...
          <!-- Container Slides -->
          <div ref="carousel" class="flex space-x-2 transition-transform duration-500 ease-in-out"
            :style="{ transform: `translateX(-${sekarang * slideWidth}px)` }">
            <div v-for="(slide, index) in slides" :key="index" class="flex-shrink-0 w-64 text-center mt-10">
              <img :src="slide.src" alt="Guru" class="w-64 h-64 object-cover rounded-ss-[50px] rounded-se-[50px] mx-auto mb-4" />
              <div class="shadow-b-md">
                <p class="font-">{{ slide.name }}</p>
                <p class="text-gray-500">{{ slide.mapel }}</p>
              </div>
            </div>
          </div>
      ...
      <div class="gallery">
        <p class="font-semibold text-[2rem]">Galeri</p>
        <div class="overflow-hidden">
          <div class="marque--inner flex flex-row justify-center px-24 gap-10">
      ...
      <div class="Alumni">
        <p class="font-semibold text-[2rem]">Apa Kata <span class="text-[#11224e]">Alumni?</span></p>
      </div>
    </div>
  </div>
</template>
...
const slides = ([
  { src: pp, name: 'Nama Guru', mapel: 'Mata Pelajaran' },
  { src: pp, name: 'Nama Guru', mapel: 'Mata Pelajaran' },
  { src: pp, name: 'Nama Guru', mapel: 'Mata Pelajaran' },
  { src: pp, name: 'Nama Guru', mapel: 'Mata Pelajaran' },
  { src: pp, name: 'Nama Guru', mapel: 'Mata Pelajaran' },
...
const slideWidth = 245; // Lebar setiap slide (sesuai dengan Tailwind w-64)
